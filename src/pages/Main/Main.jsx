...
export default function Main({ exitPage, cycleExitPage, exitY, cycleExitY }) {
    ...
    return (
        ...
        <motion.h4  className={styles.fullstack} variants={base}  initial="initial"
                animate="animate"
                exit="exit">Full Stack Developer<span className={styles.fullstackLine}></span></motion.h4>
        <motion.div className={styles.titleContainer} variants={base}  initial="initial"
                animate="animate"
                exit="exit" transition={childTransition}>
            <motion.h1 variants={children} className={styles.title}>Oriol Arias Pérez</motion.h1>
          <motion.q variants={children} className={styles.quote}>Choose a job you love, and you will never have to work a day in your life.</motion.q> 
        ...
        <div className={styles.linksIcons}>
            ...
            <a className={styles.download} href={CV} download="CV Oriol Arias -- ¡Contratar!">Download CV</a>
        </div>
        </motion.div>
        <motion.svg className={styles.image} variants={children}  initial="initial"
                animate="animate"
                exit="exit" id="10015.io" viewBox="0 0 480 480" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" >
	<defs>
		<clipPath id="blob">
			<path  d="M391,297.5Q306,355,223,384Q140,413,109,326.5Q78,216,99.5,132Q142,20,216,40Q337,58,414,143Q476,240,391,297.5Z" />
		</clipPath>
	</defs>
	<image x="-110" y="0" width="150%" height="100%" clipPath="url(#blob)" href="https://i.postimg.cc/C1hDMz8d/foto-uri-cv-1-2000x1125.png" ></image>
</motion.svg>
